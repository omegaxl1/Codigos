         ...
         <div style="width:50%; float:left;">
              ...
              <div class="form-group ">
                <label class="col-lg-2 control-label" for="ci">Ci</label>
                 <div class="col-lg-9">
                <input disabled type="text" name="ci" class="form-control" value="{{ old('ci',$patientedit->ci) }}"> 
                </div>    
            </div>
            ...
            <div class="form-group ">
                 <label class="col-lg-2 control-label" for="namef">Nombre</label>
                  <div class="col-lg-9">
                <input disabled type="text" onkeyup="mayus(this);"  name="namef" class="form-control" value="{{ old('namef',$patientedit->namef) }}">   
                </div>  
            </div>
 ...
 <div class="col-lg-6">
             <select disabled name="id_gender" class="form-control">
     ...
     @endforeach
      ...
      <div style="width:50%; float:left; margin-bottom: 10px;">
         ...
         <div class="form-group ">
                ...
                <div class="col-lg-9">
                <input disabled type="date" name="birthday" class="form-control" value="{{ old('birthday', $patientedit->birthday) }}">
              </div>
         ...
         <div class="form-group ">
                <label class="col-lg-2 control-label" for="lastname">Apellidos</label>
                 <div class="col-lg-9">
                <input disabled type="text" onkeyup="mayus(this);"  name="lastname" class="form-control" value="{{ old('lastname', $patientedit->namel) }}">
 ...
 <div class="form-group">
    ...
    <div class="col-lg-8">
             <select disabled name="id_bloodtype" class="form-control">
