 <div class="form-group">
      ...
      <option value="{{$cpsp->id}}"@if($cpsp->id == $editexplo->id_head) selected @endif>{{$cpsp->dcpsp}}</option>
      ...
      <div class="col-lg-5">
        <select  class="form-control" name="id_eyes" >
          <option value=""></option>
          @foreach ($cpsps as $cpsp)
     <option value="{{$cpsp->id}}"@if($cpsp->id == $editexplo->id_eyes) selected @endif>{{$cpsp->dcpsp}}</option>
      ...
      <div class="col-lg-5">
        <select  class="form-control" name="id_ears" >
          <option value=""></option>
          @foreach ($cpsps as $cpsp)
      <option value="{{$cpsp->id}}"@if($cpsp->id == $editexplo->id_ears) selected @endif>{{$cpsp->dcpsp}}</option>
      ...
      <div class="col-lg-5">
        <select  class="form-control" name="id_nose" >
          <option value=""></option>
          @foreach ($cpsps as $cpsp)
      <option value="{{$cpsp->id}}"@if($cpsp->id == $editexplo->id_nose) selected @endif>{{$cpsp->dcpsp}}</option>
      ...
      <div class="col-lg-5">
        <select  class="form-control" name="id_abdomen" >
          <option value=""></option>
          @foreach ($cpsps as $cpsp)
      <option value="{{$cpsp->id}}"@if($cpsp->id == $editexplo->id_abdomen) selected @endif>{{$cpsp->dcpsp}}</option>
