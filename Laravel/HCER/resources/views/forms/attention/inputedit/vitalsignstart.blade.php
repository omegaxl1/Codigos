<div class="form-group">
        ...
        <div class="col-lg-3">
        <input  type="text" class="form-control" name="heartrate" value="{{old('heartrate',$editvital->heartrate)}}">
        ...
        <label for="head_circunference" class="col-lg-4 control-label">Perimetro Cefálico</label>
         <div class="col-lg-3">
        <input type="text" class="form-control" name="head_circunference" value="{{old('head_circunference',$editvital->head_circunference)}}">
        </div>
         <div class="col-lg-2">
        ...
        <label for="bloodpressure" class="col-lg-4 control-label">Tensión Arterial</label>
         <div class="col-lg-3">
        <input type="text" class="form-control" name="bloodpressure" value="{{old('bloodpressure',$editvital->bloodpressure)}}">
        </div>
       </div>
         <div class="form-group">
        <label for="weight" class="col-lg-4 control-label">Peso</label>
         <div class="col-lg-3">
        <input type="text" class="form-control" name="weight" value="{{old('weight',$editvital->weight)}}" id="campo_1" onchange="sumar(this.value);">
        </div>
        <div class="col-lg-2">
