...
class CreatePatientUpdateMedic extends FormRequest
{
    /**
    ...
    public function messages()
    {
        ...
        return [
            ...
            'birthday.required'=>'Ingrese la fecha de nacimiento del paciente.',
            'birthday.before'=>'Ingrese una fecha valida.',
            ...
            'phone.required'=>'Ingrese un número teléfono',
            ...
            'email.email'=>'Ingrese Correo electrónico Valido',
